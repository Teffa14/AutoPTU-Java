...
def main() -> None:
    ...
    with output.open("w", encoding="utf-8") as handle:
        ...
        _write_row(handle, "ACTION_ORDER", "consume_ap", "quick_switch_sent_out", "trainer_feature_event", "apply_switch")
        ...
        _write_row(handle, "TRIGGER_ORDER", "consume_ap", "quick_switch_sent_out", "trainer_feature_event", "apply_switch")
