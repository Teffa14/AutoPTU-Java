...
val oracleDefiantCompetitive = providers.gradleProperty("oracleDefiantCompetitive")
...
tasks.test {
    ...
    if (oracleDefiantCompetitive.isPresent) systemProperty("autoptu.defiant.competitive.oracle", oracleDefiantCompetitive.get())
}
